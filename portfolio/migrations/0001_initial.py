    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tagged_portfolios', to='core.tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('information', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='portfolioInformations', to='core.information')),
                ('portfolio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='portfolio_information', to='portfolio.portfolio')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='tags',
            field=taggit.managers.TaggableManager(blank=True, help_text='해시태그를 입력해주세요', through='portfolio.TaggedPortfolio', to='taggit.Tag', verbose_name='tags'),
        ),
        migrations.AddField(
            model_name='portfolio',
            name='thumbnail',
