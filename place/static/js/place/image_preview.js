( /* att_zone : 이미지들이 들어갈 위치 id, id_images : file tag id */
  imageView = function imageView(att_zone, id_images){
    ...
    // 미리보기 이미지 속성
    var img_style = 'width:70px;height:70px;margin-right:1px;margin-bottom:4px;z-index:none;object-fit:cover;';
    // 이미지안에 표시되는 체크박스의 속성
    var chk_style = 'width:14px;height:14px;position:absolute;right:10px;top:10px;text-align:center;'
