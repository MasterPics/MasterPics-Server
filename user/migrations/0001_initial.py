    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('photographer', 'photographer'), ('model', 'model'), ('HairMakeup', 'HairMakeup'), ('stylist', 'stylist'), ('otheruse', 'otheruse')], default='otheruse', max_length=20)),
                ('image', models.ImageField(blank=True, default='user/profile_photo/default/profile_default.png', upload_to=user.utils.user_uuid_name_upload_to)),
