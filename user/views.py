...
class CsRegisterView(CreateView):
    model = User
    template_name = 'profile/register_cs.html'
    ...
    def get_success_url(self):
        ...
        # return reverse('profile:register_success')
        return redirect('profile:register_success')
    ...
    def form_valid(self, form):
        ...
        send_mail(
            ...
            [self.object.email],
            html=render_to_string('profile/register_email.html', {
                'user': self.object,
